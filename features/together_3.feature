Feature: best permutation problem
  ...
  Scenario Outline: you have a knapsack with a fixed capacity , and  a bunch of items with different weight
    ...
    When try to pick up the items in order to keep the sum of their ratio value largest, but the selected signals should be unique in the permutation
...
#      | signal_16.xlsx   | 6               | (z1001,z1002),(z1004,z1009),(z1005,z1016)                       | 1.01                 |
      | signal_10_9.xlsx | 9               | (z1001,z1002),(z1004,z1005),(z1006,z1007),(z1008,z1009),(z1010) | 0.61                 |
      | signal_10_8.xlsx | 8               | (z1001,z1004),(z1005,z1006),(z1007,z1008),(z1009,z1010)         | 0.61                 |
      | signal_10_7.xlsx | 7               | (z1001, z1004),(z1005,z1007),(z1008,z1009),(z1010)              | 0.58                 |